...
import './App.css';
import EmissionMap from './screens/currentenv/components/EmissionMap';
import EmissionTableauMap from './screens/currentenv/components/EmissionTableauMap';
function App() {
  return (
    <Router>
      <div style={{backgroundColor:"#FAFAFA"}}>
        ...
        <Routes>
          ...
          <Route path="/about" element={<EmissionMap/>}/>
          <Route path="/tableau" element={<EmissionTableauMap/>}/>
