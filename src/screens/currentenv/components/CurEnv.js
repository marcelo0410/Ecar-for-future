    ...
    <div id="cur_info_container" className='cur_info_container'>
        <div id="tileArea" className='tile-flex d-flex justify-content-center'>
            <div id="cur3" style={{width:"33%"}}>
                <div><img src={curE1} style={{width:"10rem"}}></img></div>
            ...
            <div id="cur17" style={{width:"33%"}}>
                <div>
                    <img src={curE2} style={{width:"8rem", marginTop:"10px"}}></img>
                </div>
                <img src={cur17Image} style={{marginTop:"20px", height:"63px", width:"160px"}}></img>
            ...
            <div id="cur60" style={{width:"33%"}}>
                <div><img src={curE3} style={{width:"9rem", marginTop:"10px"}}></img></div>
                <img src={cur60Image} style={{height:"66px", width:"160px", marginLeft:"20px", marginBottom:"0px"}}></img>
